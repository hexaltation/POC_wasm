...
document.getElementById("cbutton").onclick = clication;
...
function integrateWasmJS() {
  ...
  var wasmTextFile = 'write.wast';
  var wasmBinaryFile = 'write.wasm';
  var asmjsCodeFile = 'write.temp.asm.js';
...
/** @type {function(Array=)} */
function run(args) {
  console.log('I run ran run')
  var newinput = document.querySelector("#cinput").value + "\n";
  Module['arguments'].push(newinput);
  console.log(Module['arguments'])
